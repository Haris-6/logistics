...
import FormikController from '../../components/formik/formikController'; //for execution of form field
import Button from '../../components/button';
import UploadImage from '../../components/fileUpload';
import { INVENTORYOPTIONS, OPTIONS } from '../../utils/data';
import axios from 'axios'; //library use to posting or geting data from frontend to backend
import { toast } from 'react-toastify';
import { getToken } from '../../utils/currentUser';
import { useDispatch } from 'react-redux';
import { inventoryAddApi } from '../../redux/api/inventoryAdd'; //function use to get all inventory details
